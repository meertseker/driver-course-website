      ...
      <div className="mx-auto grid w-full max-w-7xl gap-8 px-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li>
              <a href="mailto:avcilar@efesurucukursu.com" className="hover:text-primary transition">
                avcilar@efesurucukursu.com
              </a>
            </li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li>
              <a href="mailto:buyukcekmece@efesurucukursu.com" className="hover:text-primary transition">
                buyukcekmece@efesurucukursu.com
              </a>
            </li>

        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between gap-x-6 gap-y-0.5">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-0.5">
            <a href="tel:+902125902325" className="flex items-center gap-2">
              <svg className="w-3.5 h-3.5 text-secondary-orange shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
              </svg>
              <span className="text-white hover:text-secondary-gold transition-colors font-semibold">+90 (212) 590 23 25</span>
            </a>
            <a href="tel:+905469402200" className="flex items-center gap-2 text-white/70 hover:text-secondary-gold transition-colors">
              <svg className="w-3.5 h-3.5 text-secondary-orange/80 shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden md:flex items-center gap-8">
            {menuItems.map((item, index) => (
              ...
              >
                <Link
                  href={item.href}
                    className="relative text-white hover:text-secondary-gold font-semibold transition-colors duration-300 group py-2"
                >
                  {item.label}
                  <motion.span 

        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">
              Avcılar Sürücü Kursu, İstanbul Avcılar ve Büyükçekmece şubelerinde tüm ehliyet sınıfları için MEB onaylı teorik ve direksiyon eğitimi sunar. %94 başarı oranıyla 15.000&apos;den fazla mezun.
            </p>
          </div>

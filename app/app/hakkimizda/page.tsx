...
export const metadata: Metadata = {
  title: 'Hakkımızda - Avcılar Sürücü Kursu',
  description: 'Avcılar Sürücü Kursu\'nun Büyükçekmece merkezli eğitim yaklaşımı, kayıt süreci ve aday desteği hakkında bilgi alın.',
};

...
export const metadata: Metadata = {
  title: 'Gizlilik Politikası - Avcılar Sürücü Kursu',
  description: 'Avcılar Sürücü Kursu web sitesinde paylaşılan kişisel verilerin nasıl işlendiğine dair temel bilgilendirme.',
};

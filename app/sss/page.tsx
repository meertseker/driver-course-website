...
export const metadata: Metadata = {
  ...
  keywords: ['ehliyet SSS', 'sürücü kursu soruları', 'Avcılar Sürücü Kursu', 'ehliyet sınavı'],
  openGraph: {
    title: 'Sıkça Sorulan Sorular | Avcılar Sürücü Kursu',
    description: 'Ehliyet kursu hakkında merak ettiğiniz soruların cevapları.',
    url: 'https://www.avcilarehliyetkursu.com/sss',
  },
};
...
export default function SSSPage() {
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'SSS', url: 'https://www.avcilarehliyetkursu.com/sss' }
  ]);
